...
class Table_wrap:
    ...
    def make_DTD(self):
        ...
        G.add_edge('alt-text', 'table')
        G.add_edge('alt-text', 'xref')
        G.add_edge('alt-text', 'table-wrap-foot')
        ...
        G.add_edge('long-desc', 'table')
        G.add_edge('long-desc', 'xref')
        G.add_edge('long-desc', 'table-wrap-foot')
        ...
        G.add_edge('email', 'table')
        G.add_edge('email', 'xref')
        G.add_edge('email', 'table-wrap-foot')
        ...
        G.add_edge('ext-link', 'table')
        G.add_edge('ext-link', 'xref')
        G.add_edge('ext-link', 'table-wrap-foot')
        ...
        G.add_edge('uri', 'table')
        G.add_edge('uri', 'xref')
        G.add_edge('uri', 'table-wrap-foot')
        ...
        G.add_edge('subj-group', 'table-wrap-foot')
        ...
        G.add_edge('kwd-group', 'table-wrap-foot')
        ...
        G.add_edge('abstract', 'table-wrap-foot')
        ...
        G.add_edge('caption', 'table-wrap-foot')
        ...
        G.add_edge('label', 'table-wrap-foot')
        ...
        G.add_edge('object-id', 'table-wrap-foot')
        G.add_edge('object-id', 'attrib')
        G.add_edge('object-id', 'permissions')
        G.add_edge('table-wrap-foot', 'accept')
