...
class License_p:
    ...
    def make_DTD(self):
        ...
        G.add_edge('start', 'citation-alternatives')
        G.add_edge('start', 'element-citation')
        G.add_edge('start', 'mixed-citation')
        G.add_edge('start', 'nlm-citation')
        G.add_edge('start', 'award-id')
        G.add_edge('start', 'funding-source')
        G.add_edge('start', 'open-access')
