...
import json
import subprocess
import endnotes, quotations, src, links, references
...
def main(input_filepath, output_filepath, reference_input_filepath, reference_output_filepath):
    ...
    src.modify.fix_article_meta(output_filepath, output_filepath)
...
if __name__ == '__main__':
    input_filepath            = './test/NBDT_Template/main.tex'
    reference_input_filepath  = './test/NBDT_Template/sample.bib'
    output_filepath           = 'output.xml'
    reference_output_filepath = 'output.bib'
